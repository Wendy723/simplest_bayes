...
" WRITE(50,'(I12,1X,F14.0,5(1X,1PG12.5))') ITER_REPORT,ID,CL,V
ENDIF
...
$EST METHOD=CHAIN FILE=run006chains.chn NSAMPLE=5 ISAMPLE=0 DF=20
$EST METHOD=BAYES INTER NBURN=0 NITER=0 PRINT=20 NOPRIOR=0 CTYPE=3 CITER=10 SEED=12345