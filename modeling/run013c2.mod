$PROB one cmpt simple mu modeled bayes multidose tr
$SUB ADVAN1 TRANS2
$INPUT ID TIME DV OBSNUM CMT EVID AMT RATE ADDL II 
$DATA mdata/simple_nocovar_56id_6tp_md.csv 
IGNORE=@ IGNORE=(OCCNUM.EQN.1) IGNORE=(OCCNUM.EQN.2) IGNORE=(OCCNUM.EQN.4) IGNORE=(OCCNUM.EQN.5) IGNORE=(OCCNUM.EQN.6)
