...
IGNORE=@ IGNORE=(OBSNUM.EQN.1) IGNORE=(OBSNUM.EQN.2) IGNORE=(OBSNUM.EQN.4) IGNORE=(OBSNUM.EQN.5) IGNORE=(OBSNUM.EQN.6)
...
$EST METHOD=CHAIN FILE=..\run007chains.chn NSAMPLE=0 ISAMPLE=3 DF=20
